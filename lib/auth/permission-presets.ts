...
export const NAV_PERMISSION_RULES: Record<PermissionPresetId, string[]> = {
  admin: ["*"],
  manager: ["/", "/master/partners", "/master/products", "/master/employees", "/orders", "/orders/review", "/inventory/documents", "/inventory/stock", "/accounting/sales", "/accounting/cash", "/accounting/debt", "/accounting/summary", "/hr/attendance", "/hr/payroll"],
  accountant: ["/", "/master/partners", "/orders", "/accounting/sales", "/accounting/cash", "/accounting/debt", "/accounting/summary", "/hr/payroll"],
  sales: ["/", "/master/partners", "/master/prices", "/orders", "/orders/review", "/accounting/sales", "/accounting/debt", "/accounting/summary"],
